...
My research interests lie primarily in Click-through rate (CTR) prediction, deep Stochastic Contextual Bandits, and deep learning-based Disease Diagnosis models using brain Magnetic resonance imaging (MRI) image datasets.
