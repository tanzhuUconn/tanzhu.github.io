...
My research interests lie primarily in explainable recommendation systems, reinforcement learning, and  deep Learning for MRI Diagnostics, with an emphasis on **attention module**, **Click-through Rate Prediction (CTR)**, **stochastic contexture bandit problem**, and **DNN model diagnosing alcohol/nicotine use disorder with brain image datasets**.
